...
from app.skills.business.crawlers.wechat.core import finalize_daily_run
from app.skills.business.crawlers.io import load_json_file
...
class WechatFinalizeDailySkill(BaseSkill):
    ...
    async def execute(self, inputs: dict[str, Any]) -> dict[str, Any]:
        paths = CrawlPaths(resolve_config_root(inputs["paths"]))
